...
void AudioPlayerAudioProcessor::togglePlaying()
{
    isPlaying = !isPlaying;
}

void AudioPlayerAudioProcessor::loadAudioFile(const juce::File& audioFile)
{
    ...
    if (reader != nullptr)
    {
        ...
        transportSource.setSource(currentSource.get(), 0, nullptr, reader->sampleRate);
    }
}
